...
public final class JPEGReader {
    ...
    public static final String moduleName = "JPEGReaderPlugin * VMMaker.oscog-eem.2480 (GraalSqueak)";
    ...
    private static boolean colorComponentBlocksfrom(final int[][] blocks, final Object oop) {
        ...
        final PointersNonVariableObject pointersOop = (PointersNonVariableObject) oop;
        ...
        final PointersNonVariableObject arrayPointersOop = (PointersNonVariableObject) arrayOop;
    ...
    private boolean loadJPEGStreamFrom(final PointersNonVariableObject streamOop) {
        final Object oop;
        final int sz;
    ...
    public Object primitiveColorConvertMCU(final Object receiver, final PointersNonVariableObject componentArray, final NativeObject bits, final NativeObject residualArray, final long mask) {
        int blockIndex;
        int blue;
        int cb;
        int cr;
    ...
    public Object primitiveDecodeMCU(final Object receiver, final NativeObject sampleBuffer, final PointersNonVariableObject comp, final NativeObject dcTableValue, final NativeObject acTableValue,
    ...
    private void storeJPEGStreamOn(final PointersNonVariableObject streamOop) {
    ...
    private int fetchIntegerofObject(final int index, final PointersNonVariableObject arrayOop) {
    ...
    private static int slotSizeOf(final PointersNonVariableObject pointerOop) {
