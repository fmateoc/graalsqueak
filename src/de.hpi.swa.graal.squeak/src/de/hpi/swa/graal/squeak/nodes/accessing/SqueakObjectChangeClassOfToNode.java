...
public abstract class SqueakObjectChangeClassOfToNode extends AbstractNode {
    ...
    @Specialization(guards = {"!receiver.haveSameStorageType(argument)", "argument.isBytes()"})
    ...
    @Specialization(guards = {"!receiver.haveSameStorageType(argument)", "argument.isShorts()"})
    ...
    @Specialization(guards = {"!receiver.haveSameStorageType(argument)", "argument.isWords()"})
    ...
    @Specialization(guards = {"!receiver.haveSameStorageType(argument)", "argument.isLongs()"})
    ...
    @Specialization(guards = {"!isNativeObject(receiver)", "!isLargeIntegerObject(receiver)", "!isFloatObject(receiver)", "receiver.getSqueakClass().getFormat() == argument.getFormat()"})
