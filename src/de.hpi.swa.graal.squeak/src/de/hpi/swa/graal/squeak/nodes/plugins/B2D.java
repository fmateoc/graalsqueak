...
public final class B2D {
    ...
    private static void loadArrayTransformFromintolength(final ArrayObject transformOop, final int destPtr, final long n) {
        ...
        for (int i = 0; i < n; i++) {
            final Object value = objectLibrary.at0(transformOop, i);
    ...
    private static int loadRenderingState(final PointersObject receiver, final PointersObject edgeOop, final PointersObject fillOop) {
        int failCode;
        final long state;
    ...
    private static int loadSpanBufferFrom(final NativeObject spanOop) {
    ...
    private static int loadWorkBufferFrom(final NativeObject wbOop) {
        if (!isWords(wbOop)) {
    ...
    private static int quickLoadEngineFrom(final PointersObject engineOop) {
        if (failed()) {
    ...
    private static int quickLoadEngineFromrequiredState(final PointersObject oop, final long requiredState) {
    ...
    private static int quickLoadEngineFromrequiredStateor(final PointersObject oop, final long requiredState, final long alternativeState) {
        final int failureCode = quickLoadEngineFrom(oop);
        if (failureCode != 0) {
            return failureCode;
        }
    ...
    private static PointersObject fetchPointerofObject(final int index, final ArrayObject object) {
        return (PointersObject) SqueakObjectLibrary.getUncached().at0(object, index);
    }

    private static int slotSizeOf(final ArrayObject object) {
        return SqueakObjectLibrary.getUncached().size(object);
    }
