...
public class SqueakMessageInterceptor {
    ...
    public static void clear() {
        selectorToClassesMap.clear();
        nativeSelectorToClassMap.clear();
        nativeSelectorToStringMap.clear();
    }
...
// }
        ...
        for (final ClassObject aClass : selectorToClassesMap.remove(requested)) {
            ...
            nativeSelectorToStringMap.put(symbol, "Entering " + aClass.getClassNameUnsafe() + ">>" + symbol.asStringUnsafe() + " ...");
        }
    }
