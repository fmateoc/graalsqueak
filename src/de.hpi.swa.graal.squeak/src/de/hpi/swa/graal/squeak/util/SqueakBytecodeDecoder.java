...
public final class SqueakBytecodeDecoder {
    ...
    public static int tempCountForBlock(final CompiledBlockObject code) {
        int stackPointer = 0;
        final byte[] bytecode = code.getBytes();
        final int b = Byte.toUnsignedInt(bytecode[0]);
        if (b == 115) {
            final Map<Integer, Integer> joinDict = new HashMap<>();
            int index = 0;
            while (index < bytecode.length) {
                final int length = decodeNumBytes(code, index);
                stackPointer = decodeStackp(code, index, length, stackPointer, joinDict);
                index += length;
            }
        }
    ...
    public static int decodeStackp(final CompiledCodeObject code, final int index, final int numBytes, final int stackp, final Map<Integer, Integer> joinDict) {
        final byte[] bytecode = code.getBytes();
        ...
        switch (b) {
            ...
            case 120: case 121: case 122: case 123:
                return stackp;
            case 124: case 125:
                if (index + numBytes < bytecode.length) {
                    return joinDict.get(index + numBytes);
                }
                return stackp - 1;
            case 126: case 127:
                return stackp;
            ...
            case 130:
                return stackp - 1;
            case 131:
                return stackp - (Byte.toUnsignedInt(bytecode[index + 1]) >> 5);
            case 132:
                final int type = Byte.toUnsignedInt(bytecode[index + 1]) >> 5;
                switch(type) {
                    case 0: case 1:
                        return stackp - (Byte.toUnsignedInt(bytecode[index + 1]) & 31);
            ...
            case 133:
                return stackp - (Byte.toUnsignedInt(bytecode[index + 1]) >> 5);
            case 134:
                return stackp - (Byte.toUnsignedInt(bytecode[index + 1]) >> 6);
            case 135:
                return stackp - 1;
            case 136: case 137:
                return stackp + 1;
            case 138:
                final int param = Byte.toUnsignedInt(bytecode[index + 1]);
                return param > 128 ? stackp + 129 - param : stackp + 1;
            case 139:
                return stackp;
            case 140:
                return stackp + 1;
            ...
            case 142:
                return stackp - 1;
            case 143:
                return stackp + 1 - (Byte.toUnsignedInt(bytecode[index + 1]) >> 4 & 0xF);
            case 144: case 145: case 146: case 147: case 148: case 149: case 150: case 151:
                if (b > 0) {
                    joinDict.put(index + numBytes + (b & 7) + 1, stackp);
                    if (index + numBytes < bytecode.length) {
                        return joinDict.get(index + numBytes);
                    }
                }
            ...
            case 152: case 153: case 154: case 155: case 156: case 157: case 158: case 159:
                if (b > 0) {
                    joinDict.put(index + numBytes + (b & 7) + 1, stackp - 1);
                    return stackp - 1;
                }
                return stackp;
            case 160: case 161: case 162: case 163: case 164: case 165: case 166: case 167:
                int offset = ((b & 7) - 4 << 8) + Byte.toUnsignedInt(bytecode[index + 1]);
                if (offset > 0) {
                    joinDict.put(index + numBytes + offset, stackp);
                    if (index + numBytes < bytecode.length) {
                        return joinDict.get(index + numBytes);
                    }
                }
            ...
            case 168: case 169: case 170: case 171: case 172: case 173: case 174: case 175:
                offset = ((b & 3) << 8) + Byte.toUnsignedInt(bytecode[index + 1]);
                if (offset > 0) {
                    joinDict.put(index + numBytes + offset, stackp - 1);
                    return stackp - 1;
                }
                return stackp;
            ...
            case 200: case 201: case 202: case 203: case 204: case 205: case 206: case 207:
                return stackp - code.image.getSpecialSelectorNumArgs(b - 176);
