    ...
    public static AbstractBytecodeNode decodeBytecode(final CompiledCodeObject code, final int index) {
        ...
        switch (b) {
            ...
            case 88: case 89: case 90: case 91: case 92: case 93: case 94: case 95:
                return PushLiteralVariableNode.create(code, index, 1, b & 31);
            ...
            case 140:
                return PushRemoteTempNode.create(code, index, 3, Byte.toUnsignedInt(bytecode[index + 1]), Byte.toUnsignedInt(bytecode[index + 2]));
            case 141:
