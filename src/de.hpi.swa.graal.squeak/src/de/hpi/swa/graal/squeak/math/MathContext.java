 ...
 * numerical operators, such as those implemented by the {@link BigDecimal} class.
 *
 * <p>
 * The base-independent settings are:
 * <ol>
 * <li>{@code precision}: the number of digits to be used for an operation; results are rounded to
 * this precision
 *
 * <li>{@code roundingMode}: a {@link RoundingMode} object which specifies the algorithm to be used
 * for rounding.
 * </ol>
 *
 * @see BigDecimal
...
public final class MathContext implements Serializable {
     ...
     */
    public MathContext(final int setPrecision,
                    final RoundingMode setRoundingMode) {
    ...
    public boolean equals(final Object x) {
        ...
        if (!(x instanceof MathContext))
            return false;
        mc = (MathContext) x;
        return mc.precision == precision && mc.roundingMode == roundingMode; // no need for
                                                                             // .equals()
    }
