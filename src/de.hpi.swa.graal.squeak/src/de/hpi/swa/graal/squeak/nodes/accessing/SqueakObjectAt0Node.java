...
public abstract class SqueakObjectAt0Node extends AbstractNode {
    ...
    protected static final Object doImmutableConsChar(final ImmutableConsCharObject obj, final long index){
        return obj.at0(index);
    }

    @Specialization
    protected static final Object doImmutableArrayObject(final ImmutableArrayObject obj, final long index){
        return obj.at0(index);
    }
